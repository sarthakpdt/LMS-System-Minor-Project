            ...
            <div className="p-8">
              ...
              {isLogin ? (
                ...
                <form onSubmit={handleSignup} className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="signup-year" className="text-gray-700 font-medium">Academic Year</Label>
                      <div className="relative mt-2">
                    ...
                    <div>
                      <Label htmlFor="signup-course" className="text-gray-700 font-medium">Course/Program</Label>
                      <div className="relative mt-2">
                        <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 z-10" />
                        <Select
                          value={signupData.course}
                          onValueChange={(value) => setSignupData({ ...signupData, course: value })}
                          required
                        >
                          <SelectTrigger className="pl-11 h-11 border-gray-300">
