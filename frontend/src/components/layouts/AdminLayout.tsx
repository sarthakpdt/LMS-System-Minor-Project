...
import { LayoutDashboard, Users, BookOpen, FileText, BarChart3, Shield, FolderOpen, ClipboardCheck, Sparkles, GraduationCap, UserCheck, Bell, Moon, Sun, Menu, X, Wallet } from 'lucide-react';
